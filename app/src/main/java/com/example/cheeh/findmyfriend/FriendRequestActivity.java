...
import com.example.cheeh.findmyfriend.ViewHolder.FriendRequestViewHolder;
...
public class FriendRequestActivity extends AppCompatActivity implements IFirebaseLoadDone {
    ...
    //start search value result that stores in firebase
    ...
    //adding user to new friend's info with new database child: acceptList
    ...
    //adding new friends to user's info with new database child: acceptList
                    ...
                    public void onSuccess(Void aVoid) {
                        if(isShowMessage){
                            Toast.makeText(FriendRequestActivity.this,
                                    "Request Removed!", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
    ...
    //Loading friend requests from friend request list
    private void loadFriendRequestList() {
        ...
        adapter = new FirebaseRecyclerAdapter<User, FriendRequestViewHolder>(options) {
            @Override
            protected void onBindViewHolder(@NonNull FriendRequestViewHolder holder,
                ...
                holder.btn_accept.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        deleteFriendRequest(model, false);
                        addToAcceptList(model); //see line 166
                        addUserToFriendContact(model); //see line 155
                    }
                });
                ...
                holder.btn_decline.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        deleteFriendRequest(model, true); //see line 177
                    }
                });
            }
